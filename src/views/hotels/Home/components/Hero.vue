  ...
  <section class="pt-3 pt-lg-5">
    <b-container>
      <b-row class="g-4 g-lg-5">
        <b-col lg="6" class="position-relative mb-4 mb-md-0">
          ...
          <p class="mb-4">
            We bring you not only a stay option, but an experience in your budget to enjoy the
            luxury.
          </p>
          <div class="hstack gap-4 flex-wrap align-items-center">
            <button class="btn btn-primary-soft mb-0">Discover Now</button>
            ...
            >
              <div class="avatar avatar-md z-index-1 position-relative me-2">
                ...
                <div
                  class="btn btn-xs btn-round btn-white shadow-sm position-absolute top-50 start-50 translate-middle z-index-9 mb-0 flex-centered"
                >
        ...
        <b-col lg="6" class="position-relative">
          ...
          <div class="position-absolute top-0 end-0 z-index-1 mt-n4">
            <div class="bg-blur border border-light rounded-3 text-center shadow-lg p-3">
              <BIconHeadset class="text-danger fs-3 my-2" />
...
import AvailabilityFilter from '@/views/hotels/Home/components/AvailabilityFilter.vue'
</script>
