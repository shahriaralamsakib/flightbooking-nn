<template>
  <PageLayout>
    <section class="pt-4 pt-lg-5">
      <b-container>
        <b-row>
          <b-col lg="10" class="mx-auto text-center">
            ...
            <b-form class="col-lg-8 position-relative mx-auto">
              <b-form-input
                size="lg"
                class="pe-5"
                type="search"
        ...
        <b-row>
          <b-col xl="10" class="mx-auto">
            <div class="vstack gap-4">
              <b-card no-body class="border bg-transparent p-0">
                <b-card-header class="bg-transparent border-bottom p-4">
                ...
                <b-card-body class="p-4 pt-0">
                  ...
                  <div class="mt-4">
                    ...
                    <p class="mb-0">
                      ...
                      Valley by oh twenty direct me so. Departure defective arranging rapturous did
                      believe him all had supported. Family months lasted simple set nature vulgar
                      him. Picture for attempt joy excited ten carried manners talking how.
                      Suspicion neglected the resolving agreement perceived at an. Comfort reached
                  ...
                  <div class="mt-4">
                    ...
                    <p class="mb-0">
                      ...
                      is the easiest way to make payments online. While checking out your order. Be
                      sure to fill in correct details for fast & hassle-free payment processing.
                    </p>
                  </div>
                </b-card-body>
              </b-card>

              <b-card no-body class="bg-transparent border p-0">
                <b-card-header class="bg-transparent border-bottom p-4">
    ...
    <section class="pt-0">
      <b-container>
        <div class="bg-light p-4 p-sm-5 rounded-3 position-relative overflow-hidden">
          ...
          <b-row class="g-4 justify-content-md-between align-items-center position-relative">
            <b-col xl="6">
            ...
            <b-col xl="5">
              <b-form class="bg-body rounded-2 p-2">
                <div class="d-flex">
                  ...
                  <b-button variant="dark" class="btn-round flex-shrink-0 mb-0">
                    <BIconArrowRight class="fa-fw" />
                  </b-button>
                </div>
              </b-form>
            </b-col>
...
import { BIconArrowRight, BIconHouse } from 'bootstrap-icons-vue'
</script>
