      ...
      <b-row>
        <b-col cols="12">
          <b-card no-body class="bg-dark p-3">
            <b-card-body
              class="border border-2 border-dashed border-white rounded position-relative"
            >
              <figure class="position-absolute top-0 start-0 mt-n3 ms-3">
                <svg
                  ...
                  style="enable-background: new 0 0 30.1 23.4"
                  xml:space="preserve"
                >
                  <path
                    class="fill-white"
              ...
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <router-link to="#" class="text-warning fs-4 stretched-link"
                  >Use Code: BOOK56
                </router-link>
              </div>
            </b-card-body>
