    ...
    <b-container>
      <b-row class="g-4 align-items-center">
        <b-col lg="2">
          ...
          <a href="#" class="h6 fw-normal text-primary mb-0">
            View all
            <BIconArrowRight />
          </a>
        </b-col>
        ...
        <b-col lg="10">
          <div class="tiny-slider arrow-round arrow-xs arrow-dark">
            <CustomTinySlider id="tiny-slider-inner" :settings="categorySliderSettings">
              <div>
                <b-card class="bg-light text-center align-items-center">
                  <div class="icon-xl bg-mode rounded-circle mb-3">
                    <figure>
                      <svg
                        ...
                        style="enable-background: new 0 0 47.9 47.3"
                        xml:space="preserve"
                      >
                        <path
                          class="fill-mode-inverse"
                  ...
                  <div class="icon-xl bg-mode rounded-circle mb-3">
                    <figure>
                      <svg
                        ...
                        height="51px"
                        viewBox="0 0 43.4 51"
                        style="enable-background: new 0 0 43.4 51"
                        xml:space="preserve"
                      >
                        <path
                          class="fill-mode-inverse"
                  ...
                  <div class="icon-xl bg-mode rounded-circle mb-3">
                    <figure>
                      <svg
                        width="43.7px"
                        height="38.7px"
                        viewBox="0 0 43.7 38.7"
                        style="enable-background: new 0 0 43.7 38.7"
                        xml:space="preserve"
                      >
                        <path
                          class="fill-mode-inverse"
                  ...
                  <div class="icon-xl bg-mode rounded-circle mb-3">
                    <figure>
                      <svg
                        ...
                        style="enable-background: new 0 0 42.7 42.7"
                        xml:space="preserve"
                      >
                        <path
                          class="fill-mode-inverse"
                  ...
                  <div class="icon-xl bg-mode rounded-circle mb-3">
                    <figure>
                      <svg
                        width="46.6px"
                        height="53.3px"
                        viewBox="0 0 46.6 53.3"
                        style="enable-background: new 0 0 46.6 53.3"
                        xml:space="preserve"
                      >
                        <path
                          class="fill-primary"
