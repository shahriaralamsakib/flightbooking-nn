    ...
    <b-container>
      <b-row class="g-4">
        <b-col lg="4" class="position-relative">
          ...
          <img :src="aboutImg9" class="rounded-3" alt="" />
        ...
        <b-col lg="7" class="position-relative ms-auto">
          ...
          <div class="position-relative mb-5">
            <img :src="aboutImg10" class="rounded-3" alt="" />

            <div class="position-absolute bottom-0 start-0 ms-n3 ms-lg-n6 mb-2 z-index-1">
              <div
                class="bg-mode shadow d-inline-block text-center rounded-3 position-relative p-4"
              >
              ...
              <div class="d-flex">
                <figure>
                  <svg
                    ...
                    style="enable-background: new 0 0 50.1 49.9"
                    xml:space="preserve"
                  >
                    <path
                      class="fill-primary"
              ...
              <div class="d-flex">
                <figure>
                  <svg
                    ...
                    style="enable-background: new 0 0 49.3 56.1"
                    xml:space="preserve"
                  >
                    <path
                      class="fill-primary"
              ...
              <div class="d-flex">
                <figure>
                  <svg
                    ...
                    style="enable-background: new 0 0 50.5 44.2"
                    xml:space="preserve"
                  >
                    <path
                      class="fill-primary"
